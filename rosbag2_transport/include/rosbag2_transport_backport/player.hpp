...
#include "rosbag2_interfaces_backport/srv/seek.hpp"
...
protected:
  ...
  std::unordered_map<std::string, std::shared_ptr<rosbag2_transport::GenericPublisher>> publishers_;
...
private:
  ...
  rclcpp::Service<rosbag2_interfaces_backport::srv::Seek>::SharedPtr srv_seek_;
  ...
  {
    return rosbag2_transport::create_generic_publisher(
